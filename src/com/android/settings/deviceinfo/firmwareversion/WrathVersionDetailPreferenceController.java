...
public class WrathVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "WrathVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_WRATH_VERSION_PROP = "ro.wrath.version";
    private static final String KEY_WRATH_BUILDTYPE_PROP = "ro.wrath.build_type";
    ...
    public WrathVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(KEY_WRATH_VERSION_PROP,
                mContext.getString(R.string.unknown)) + " | " + SystemProperties.get(KEY_WRATH_BUILDTYPE_PROP, mContext.getString(R.string.unknown));
    }
